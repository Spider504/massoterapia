...
function check() {
	...
	if (valorDura && valorTera) {
		...
		if (valorHoras == 4 && valorTera > 1) {
			descricao.innerHTML = "Quick massage em evento corporativo de " + valorHoras + " horas com " + valorTera + " terapeutas profissionais para quantidade aproximada de " + valorTera * 13 + " atendimentos, considerando de 10 a 15 minutos de massagem por pessoa."
		} else if (valorHoras == 4 && valorTera == 1) {
			descricao.innerHTML = "Quick massage em evento corporativo de " + valorHoras + " horas com " + valorTera + " terapeuta profissional para quantidade aproximada de " + valorTera * 13 + " atendimentos, considerando de 10 a 15 minutos de massagem por pessoa."
		} else if (valorHoras == 6 && valorTera == 1) {
			descricao.innerHTML = "Quick massage em evento corporativo de " + valorHoras + " horas com " + valorTera + " terapeuta profissional para quantidade aproximada de " + valorTera * 19 + " atendimentos, considerando de 10 a 15 minutos de massagem por pessoa."
		} else if (valorHoras == 6 && valorTera > 1) {
			descricao.innerHTML = "Quick massage em evento corporativo de " + valorHoras + " horas com " + valorTera + " terapeutas profissionais para quantidade aproximada de " + valorTera * 19 + " atendimentos, considerando de 10 a 15 minutos de massagem por pessoa."
		} else if (valorHoras == 8 && valorTera == 1) {
			descricao.innerHTML = "Quick massage em evento corporativo de " + valorHoras + " horas com " + valorTera + " terapeuta profissional para quantidade aproximada de " + valorTera * 25 + " atendimentos, considerando de 10 a 15 minutos de massagem por pessoa."
		} else if (valorHoras == 8 && valorTera > 1) {
			descricao.innerHTML = "Quick massage em evento corporativo de " + valorHoras + " horas com " + valorTera + " terapeutas profissionais para quantidade aproximada de " + valorTera * 25 + " atendimentos, considerando de 10 a 15 minutos de massagem por pessoa."
		}
		// 6 horas
		// 38
		// 57
